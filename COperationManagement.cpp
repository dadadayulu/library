...
//负责登录，注册，管理员，将图书，初始化操作，将借阅信息等从文件中读取出来，
//放入容器中，便于操作
...
void COperationManagement::adminOperation(CAdministrator admin, CManagementBooks mb)
{
	while (1)
	{
		cout << "请选择您的操作 1.增加书 2.查看当前借阅情况 3.查看当前所有图书信息情况 4.查看借阅人详细信息 5.删除图书 6.修改图书信息 7.退出" << endl;
		int t;
		cin >> t;
		if (t == 1)
		{
		...
		else if (t == 5)
		{
			...
			cout << "请输入您要删除的图书名称:" << endl;
			cin >> bookName;
			cout << "请输入您要删除的图书作者:" << endl;
			cin >> bookAuthor;
		...
		else if (t == 6)
		{
			mb.showAllBooksInfo();
			string bookName,bookAuthor;
			cout << "请输入您要修的图书名称:" << endl;
			cin >> bookName;
			cout << "请输入您要修的图书作者:" << endl;
			cin >> bookAuthor;
